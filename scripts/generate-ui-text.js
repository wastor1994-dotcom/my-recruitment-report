...
const strings = {
  ...
  monthlyByNotifyTitle: "สรุปรายเดือน",
  monthlyByNotifySubtitle:
    "จากชีต ภาพรวม — Pass/Fail ตามเดือน วันที่เริ่มงาน | ค้าง/รวม ตามเดือน วันที่แจ้ง (แยกเกิน/ไม่เกิน 15 วัน จาก ระยะเวลาสรรหา)",
  monthlyByStartTitle: "จำนวนปิดใบขอรายเดือน",
  monthlyByStartSubtitle:
    "จากชีต ภาพรวม — สถานะ เริ่มงาน นับตามเดือน วันที่เริ่มงาน / เดือนที่เริ่มงาน",
